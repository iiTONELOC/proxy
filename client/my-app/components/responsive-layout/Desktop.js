            ...
            <section className="static flex flex-row gap-2 justify-start h-full w-full" >
                ...
                {display !== 'single' ?
                    <>
                        ...
                        <div className="bg-gray-600 w-5/12  md:w-4/12 lg:w-3/12 p-1 flex flex-col gap-2">{UsersInRange ? <UsersInRange.Element {...UsersInRange.props} /> : null} <FriendsList />  </div>
